...
@pytest.mark.parametrize('data_files, log_file, load_exact, load_latest, expected_return_value, message_log_message', [
    ...
    (['data.json'], 'log_error1.log',
     ...
     False, 'skip (same_period_not_distinct) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     {'checksum': 'other', 'bytes': 1000000, 'errors_count': 1}, (None, None, None),
     False, 'skip (same_period_less_complete) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     {'checksum': 'other', 'bytes': size, 'errors_count': 0}, (None, None, None),
     False, 'skip (same_period_less_clean) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     {'checksum': 'other', 'bytes': size - 1, 'errors_count': 1}, (None, None, None),
     True, 'ARCHIVE (same_period) scotland/20200902_052458'),
    ...
    (['data.json'], 'log_error1.log',
     ...
     False, 'skip (2020_1_other) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     None, ({'checksum': 'other', 'bytes': size - 1, 'errors_count': 1}, 2020, 9),
     True, 'ARCHIVE (2020_9_more_clean_more_complete) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     None, ({'checksum': 'other', 'bytes': 1, 'errors_count': 1}, 2020, 9),
     True, 'ARCHIVE (2020_9_more_complete) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     None, ({'checksum': 'other', 'bytes': size, 'errors_count': 2}, 2020, 9),
     True, 'ARCHIVE (2020_9_more_clean_more_complete) scotland/20200902_052458'),
    (['data.json'], 'log_error1.log',
     None, ({'checksum': 'other', 'bytes': size + 1, 'errors_count': 2}, 2020, 9),
     False, 'skip (2020_9_other) scotland/20200902_052458'),
])
